...
const ANCHORS = [
  {
    ...
    desc: 'Who am I, and what do I stand for?',
  ...
  {
    name: 'Story Bank',
    desc: 'What stories do I always tell?',
  ...
  },
  {
    ...
    desc: 'What matters to me right now?',
  ...
  {
    name: 'Roster',
    desc: 'Who are the people that matter?',
      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20 items-start">
          ...
          <div className="lg:pt-2">
            {/* Header — Chad's anchor icon + script title */}
            ...
            <div className="flex items-center gap-3">
              ...
              >
                <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                  <path d="M11 5l-4 4 4 4" stroke="#1ebeb1" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </button>
              ...
              >
                ...
                <div className="px-8 py-8 sm:px-10 sm:py-10 text-center">
                  ...
                  {/* Title */}
                  <h4 className="font-display text-navy text-2xl sm:text-3xl font-semibold mb-2 transition-colors duration-200">
                    {active.name}
                  </h4>

                  {/* Question subtitle */}
                  <p className="font-body text-navy/45 text-sm sm:text-base italic mb-4">
                    {active.desc}
                  </p>

                  {/* Detail copy */}
                  <p className="font-body text-navy/60 text-sm sm:text-base font-medium leading-relaxed max-w-sm mx-auto">
                    {active.detail}
                  </p>
                </div>
              </Link>
              ...
              >
                <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                  <path d="M7 5l4 4-4 4" stroke="#1ebeb1" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </button>
            </div>
