...
/**
 * Full-screen section intro shown when entering a new section.
 * User clicks "Begin" to start the section's questions.
 */
export function SectionTransition({
  ...
  return (
    <div className="w-full max-w-xl mx-auto text-center py-12 sm:py-16">
      ...
      {/* Section subtitle */}
      <p
        className={`font-body text-muted text-base sm:text-lg leading-relaxed max-w-md mx-auto mb-10 transition-all duration-700 delay-300 ${
          animate ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
        }`}
      >
