...
const ANCHORS = [
  ...
  },
  {
    ...
    description: 'The stories you always tell, the phrases you repeat, the moments that come up in every conversation. Raw material that makes AI sound like someone who was actually there.',
    slug: 'story-bank',
