      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 sm:px-10 lg:px-16 pt-28 sm:pt-36 pb-16 sm:pb-20">
          ...
          <p className="font-body text-cream/85 text-lg sm:text-xl leading-relaxed max-w-2xl mb-8">
            Build all six context anchors in one session &mdash; {totalQuestions}&nbsp;questions that cover who you are, how you write, what you&apos;ve lived, where you are now, where you&apos;ve been, and who matters. Plan about an hour. You can pause and come back any time. When you&apos;re done, your AI has the full picture and knows how to best work with you.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            <div>
              ...
              <p className="font-body text-navy/50 text-base leading-relaxed">
                {totalQuestions}&nbsp;questions across six categories &mdash; about an hour if you&apos;re thorough. Skip any you want. Pause and resume any time; your progress saves automatically. Upload existing documents to get a head start. Use your microphone if you think better out loud.
              </p>
            </div>
            <div>
              <div className="w-10 h-10 rounded-full bg-teal/10 flex items-center justify-center mb-4">
