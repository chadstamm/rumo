  ...
  return (
    <main className="min-h-screen bg-cream">
      ...
      <div className="bg-navy text-cream">
        <div className="max-w-5xl mx-auto px-6 sm:px-10 lg:px-16 pt-28 sm:pt-32 pb-16 sm:pb-20">
          ...
          {DOCUMENTS.map((doc, i) => (
            ...
            >
              ...
              <div className="flex items-center justify-between mb-5">
                ...
                <span className="text-2xl">{ANCHOR_ICONS[doc.slug] || '⚓'}</span>
              </div>
              ...
              <div
                ...
                style={{ background: doc.accent === 'teal' ? 'var(--teal)' : 'var(--ochre)' }}
              />
            </Link>
          ))}
        </div>
